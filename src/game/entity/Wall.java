...
/**
 * This class extends Entity and does not add any extra functionality it simply
 * sets type to be "Wall" and the correct wall sprite within the constructor
 * 
 * @author callum
 *
 */
public class Wall extends Entity {
	...
	/**
	 * Draws the sprite of the wall at this wall's position with the walls
	 * dimensions
	 */
	public void draw() {
