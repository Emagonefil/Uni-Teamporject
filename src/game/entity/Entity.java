...
/**
 * This is the base class for all entities within the game (Player, Wall, Bullet
 * etc.) objects of type Entity should not be created rather, its sub entities
 * should be used.
 * 
 * 
 * @author callum
...
public abstract class Entity implements IEntity, Serializable {
	/**
	 * The position of the centre of this entity relative to the bottom left corner
	 * of the Map/screen
	 */
	Point position;

	/**
	 * The angle in which the Entity is facing in degrees. 0 degrees is pointing in
	...
	/**
	 * This is a string which is used by the collision handling in order to
	 * determine the intended affect of a collision. This may be "Player", "Wall",
	 * "Bullet" or "Item" and is set within the relevant classes constructor.
	 */
	public String type;
	...
	/**
	 * This creates an entity with the given width, height, position and angle(in
	 * degrees)
	 * 
	...
	/**
	 * This function takes a corner and rotates it about the centre of this entity
	 * by the given angle in degrees.
	 * 
	 * @param corner The unrotated corner of this entity
	 * @param angle  The amount of degrees by which this corner is to be rotated
	 *               about the centre
	 * @return
	 */
	...
	/**
	 * This uses this entities width, height, position and angle in order to return
	 * an array containing the coordinates of this entities corners in the order:
	 * top-left, top-right, bottom-right, bottom-left. This order is chosen for ease
	 * of use with the collision detection where a 'circular' order is required.
	 * 
	 * @return The coordinates of this entities corners in the order: top-left,
