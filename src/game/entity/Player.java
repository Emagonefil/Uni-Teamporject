...
/**
 * This class is the entity that is controlled by the player/AI it extends
 * MovableEntity to add relevant features such as health and ammunition
 * 
 * @author callum
 *
 */
public class Player extends MovableEntity implements KillableEntity {
	...
	/**
	 * There are multiple possible sprites for tanks, chosen randomly when the tank
	 * is created. This field specifies which tank sprite this entity has.
	 */
	private int tankModel = 1;

	/**
	 * This takes a path to a config file and generates a new Player objects with
	 * the properties specified within the file. If any properties are missing then
	 * their default values are used instead.
	 * 
	...
	/**
	 * Create a Player with the default properties This shouldn't be used in
	 * practice.
	 */
	public Player() {
	 ...
	 * @param speed         The amount by which the player moves in a single move
	 *                      command
	 * @param rotationSpeed The amount (in degrees) by which the Player rotates in a
	 *                      sing rotate command
	...
	/**
	 * This players health. This is checked when they get hit by a bullet and if it
	 * reaches 0 then the Player is removed
	 */
	private int health;

	/**
	 * This Player's ammunition, should be checked before the Player is allowed to
	 * shoot
	 */
	private int ammo;
	...
	/**
	 * Draws the sprite of this player using the tank model of this player object at
	 * the position and angle of this player object
	 */
	@Override
	public void draw() {
	...
	/**
	 * Draws the sprite of this player with the desired tank model, at the player
	 * position and angle
	 * 
	...
	/**
	 * This returns the tank sprite number for this tank. This is used by the
	 * Renderer
	 * 
